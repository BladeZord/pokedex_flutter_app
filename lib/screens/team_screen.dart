  ...
  Widget build(BuildContext context) {
    return Consumer<TeamProvider>(
      builder: (context, teamProvider, _) {
        final equipo = teamProvider.equipo;
        return Scaffold(
          appBar: AppBar(
            title: Text(
              'Mi equipo (${equipo.length}/${TeamProvider.capacidadMaxima})',
            ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: CircleAvatar(
                        backgroundColor: ColorHelper.colorPorTipo(
                          pokemon.types.first,
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () =>
                            confirmarQuitarDelEquipo(context, pokemon),
                      ),
                      onTap: () {
                        Navigator.push(
                          context,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                context.read<TeamProvider>().quitarDelEquipo(pokemon);
